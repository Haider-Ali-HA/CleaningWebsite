...
import ResidentialImage from "../../assets/air-duct-cleaning/residential.jpg"; // Adjusted image path
    ...
    <div>
      ...
      <div className="bg-gray-50 text-gray-800">
        ...
        <section className="py-16 px-8 bg-[#0B1215]">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
            <p className="text-gray-200">
              The air ducts in your home play a critical role in maintaining air
              quality and ensuring HVAC efficiency. Over time, dirt, dust, and
              contaminants accumulate, leading to reduced airflow, increased
              energy consumption, and even safety hazards.
              <br />
              <br />
              Our expert residential duct cleaning services use powerful
              equipment and techniques to restore your ducts to optimal
              condition, ensuring a healthier living environment and improved
              system performance.
              <br />
              <br />
              From single-family homes to large estates, we provide tailored
              duct cleaning services to meet the unique needs of your residence.
            </p>
            <img
              src={ResidentialImage} // Adjusted image path
        ...
        <section className="py-16 px-5 bg-[#0B1215]">
          <h2 className="text-3xl font-bold text-center text-primary mb-8">
            Why Choose Our Residential Duct Cleaning Services?
          </h2>
