...
const BlogsData = () => {
  ...
  const { fadeInLeftAnimation, fadeInRightAnimation, fadeInDownAnimation } =
    useAnimations();
          ...
          <div className="flex items-end justify-between">
            ...
            >
              ...
              <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-200 lg:mx-0">
                ...
                air ducts, dryer vents and how to keep them sparkling clean,
                super safe and ultra-efficient.
              </p>
            </motion.div>
            <motion.div
              ref={refAnimation}
