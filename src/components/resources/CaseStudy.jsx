    ...
    <section className="py-10 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-[90rem] sm:px-6 lg:px-8">
        <div className="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
          <div className="relative flex  flex-col  lg:flex-row   gap-6 mt-10 md:mt-0">
            <div className="overflow-hidden aspect-w-3 aspect-h-4 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center flex-col">
                ...
                <Link to="/resources/case-study-1" className="text-white text-2xl font-bold text-center hover:underline">St. Peter's College </Link>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="h-full overflow-hidden aspect-w-3 aspect-h-4 relative">
                ...
                />
                <div className="absolute inset-0 flex items-center justify-center flex-col">
                  <h2 className="text-white text-2xl font-bold">Case Study 2</h2>
                  <Link to="/resources/case-study-2" className="text-white text-2xl font-bold text-center hover:underline">The Atlantic City Fire Department</Link>
                </div>
              </div>
            </div>
          </div>
